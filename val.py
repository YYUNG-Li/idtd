...
def main():
    input_folder = r"D:\dolphin_dataset\handled\oringin\detect-train-1-3\images" # 测试图片文件夹
    center_folder = r"D:\detect-label" # 中心坐标结果保存文件夹
    log_file = r"D:\detect-time-log.txt" # 保存时间结果的日志文件路径
    gt_folder = r"D:\dolphin_dataset\handled\oringin\detect-train-1-3\labels"  # 真值标签的txt文件夹路径
    result_log =  r"D:\detect-acc-log.txt"  # 保存比较结果的日志文件路径
